...
PLUGININFOEX pluginInfo = {
        ...
        "AniSmiley service is Freeware service plugin for Miranda IM to provide ability for 'Smiley add' plugin to insert animated smileys into native SRMM dialogs. To force accuracy repainting set AnimatorService\\SlowRepaint key to BYTE 1.",
        "Artem Shpynov",
        "ashpynov@gmail.com",
        "© 2007-08 Artem Shpynov, Miranda Project",
